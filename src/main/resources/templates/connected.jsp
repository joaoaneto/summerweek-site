...
<body class="container">
 ...
 <br />
 <br />
 <h4>Connected to Facebook</h4>

 <p>
  You are now connected to Facebook. Click <a href="/">here</a> to see
  some entries from your Facebook feed.
 </p>
</body>
</html>
